...
| Plan | Umfang |
|------|--------|
| `testplan-eor-fok-6r2-3sr-feldtest` | Unveröffentlichte master-Vorlage (fürs nächste Release): 3sr Benachrichtigungs-Registry, 6r2 Watchdog-Flanken, fok DST-Kamera-Schlaf, eor OTA-Auto-Rollback |
